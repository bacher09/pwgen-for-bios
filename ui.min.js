...
function toArray(b){var a=[],c;for(c in b)a.push([c,b[c]]);return a}function toDescription(b){for(var a=0;a<b.length;a++)b[a][0]=sDescription[b[a][0]];return b}function enterPress(b){var a=0;if(b.which)a=b.which;else if(window.event)a=b.keyCode;if(13==a)b.preventDefault?b.preventDefault():b.returnValue=!1,calcPass()}
