...
function calcPass(){var b=document.getElementById("serial_id").value,a=toDescription(toArray(autoGetBiosPwd(b))),b=a.length,a=converToTable(a);document.getElementById("try_this").style.display=0<b?"":"none";var c=document.getElementById("answer");document.getElementById("dell_note").style.display=0<b?"":"none";c.innerHTML=a};
