...
scancods="\x00\u001b1234567890-=\b\tqwertyuiop[]\r\u00ffasdfghjkl;'`\u00ff\\zxcvbnm,./",MD5magic_o=[3614090360,3905402710,606105819,3250441966,4118548399,1200080426,2821735955,4249261313,1770035416,2336552879,4294925233,2304563134,1804603682,4254626195,2792965006,1236535329,4129170786,3225465664,643717713,3921069994,3593408605,38016083,3634488961,3889429448,568446438,3275163606,4107603335,1163531501,2850285829,4243563512,1735328473,2368359562,4294588738,2272392833,1839030562,4259657740,2763975236,
1272893353,4139469664,3200236656,681279174,3936430074,3572445317,76029189,3654602809,3873151461,530742520,3299628645,4096336452,1126891415,2878612391,4237533241,1700485571,2399980690,4293915773,2240044497,1873313359,4264355552,2734768916,1309151649,4149444226,3174756917,718787259,3951481745];function CorectBits(a){if("object"==typeof a){for(var b=0;b<a.length;b++)a[b]|=0;return a}return a|0}var MD5magic=CorectBits(MD5magic_o);function SignedToUnsigned(a){return a>>>0}
...
function chr(a){return String.fromCharCode(a)}function div(a,b){return a/b-a%b/b}function copy_array(a){for(var b=[],c=0;c<a.length;c++)b[c]=a[c];return b}function StringToArray(a){var b=[];if("object"==typeof a)return a;for(var c=0;c<a.length;c++)b[c]=a.charCodeAt(c);return b}function ArrayToString(a){for(var b="",c=0;c<a.length;c++)b+=chr(a[c]);return b}function toByte(a){for(var b=0;b<a.length;b++)a[b]&=255;return a}function isHexNumber(a){return/[0-9ABCDEF]/gi.test(a)}
function isDecNumber(a){return/[0-9]/gi.test(a)}function filterFalse(a){for(var b=[],c=0;c<a.length;c++)a[c]&&b.push(a[c]);return b}function ByteArrToIntArr(a){for(var b=a.length>>2,c=[],d=0;d<=b;d++)c[d]=a[4*d]|a[4*d+1]<<8|a[4*d+2]<<16|a[4*d+3]<<24;return c}function StringToIntArr(a){return"object"==typeof a?ByteArrToIntArr(a):ByteArrToIntArr(StringToArray(a))}function IntToByteArr(a){var b=[];b[0]=a&255;b[1]=a>>8&255;b[2]=a>>16&255;b[3]=a>>24&255;return b}
function IntArrToByteArr(a){for(var b=[],c=0;c<a.length;c++)b=b.concat(IntToByteArr(a[c]));return b}function fill_zero(a,b,c){for(;b<c;b++)a[b]=0;return a}var keyboardDictDigits=CreateHashTable(keys(keyboardDict).slice(0,9),values(keyboardDict).slice(0,9)),keyboardDictChars=CreateHashTable(keys(keyboardDict).slice(10,36),values(keyboardDict).slice(10,36));function keyToAscii(a){for(var b="",c=0;c<a.length&&0!=a[c];c++){if(32>a[c]||127<a[c])return;b+=String.fromCharCode(a[c])}return b}
function keyboardEncToAscii(a){for(var b="",c=0;c<a.length&&0!=a[c];c++)if(a[c]in keyboardDict)b+=keyboardDict[a[c]];else return"";return b}function badCRC16(a,b){for(var c="undefined"==typeof b?0:b,d=0,d=0;d<a.length;d++)for(var c=c^a[d],e=8;e--;)c=c&1?c>>1^8193:c>>1;return c}
function bruteForce(a,b,c,d,e,f){b="undefined"==typeof b?0:b;e="undefined"==typeof e?3:e;f="undefined"==typeof f?7:f;var h=[0,0,0,0,0,0,0];if(16383<a)return"Bad hash";var k=0;c=keys(!0==("undefined"==typeof d?!0:d)?keyboardDictChars:!0==("undefined"==typeof c?!1:c)?keyboardDictDigits:keyboardDict);for(d=c.length;;){for(var l=Math.random()*d,g=0;7>g;g++)h[g]=c[Math.floor(l%d)],l*=7;k++;if(5E4<k)return"No";for(g=e;g<=f;g++)if(badCRC16(h.slice(0,g),b)==a)return h=h.slice(0,g),keyboardEncToAscii(h)}}
function calc_in(a){return[a[1]>>1,a[1]>>6|a[0]<<2,a[0]>>3]}function begin_calc(a,b){var c=[];"string"==typeof a&&(a=StringToArray(a));c[0]=a[b[3]];c[1]=a[b[3]]>>5|(a[b[2]]>>5|a[b[2]]<<3)&241;c[2]=a[b[2]]>>2;c[3]=a[b[2]]>>7|a[b[1]]<<1;c[4]=a[b[1]]>>4|a[b[0]]<<4;c=c.concat(calc_in(a));return toByte(c)}function end_calc(a,b,c,d){for(var e=0,f=[],h=0;8>h;h++)e=170,b[h]&1&&(e^=a[c[0]]),b[h]&2&&(e^=a[c[1]]),b[h]&4&&(e^=a[c[2]]),b[h]&8&&(e^=a[1]),b[h]&16&&(e^=a[0]),f[h]=d[e%d.length];return f}
...
function blockEncode(a,b,c,d,e,f,h){function k(a,c,b){c=c[b>>4][i&3];return SignedToUnsigned(a)/Math.pow(2,32-c)|SignedToUnsigned(a)<<c|0}function l(c,d,e){return n+b(c,m,p,q,MD5magic[e]+a[d])|0}var g=[1732584193,-271733879,-1732584194,271733878],n=g[0]|0,m=g[1]|0,p=g[2]|0,q=g[3]|0,s=[[7,12,17,22],[5,9,14,20],[4,11,16,23],[6,10,15,21]],r;for(j=0;j<=20*h;j++){h&&(n|=151,m^=8,p|=1616929121-j,q^=1347424272+j);for(i=0;64>i;i++){switch(i>>4){case 0:r=l(c,i&15,i);break;case 1:r=l(d,5*i+1&15,i);break;case 2:r=
l(e,3*i+5&15,i);break;case 3:r=l(f,7*i&15,i)}n=q;q=p;p=m;m=k(r,s,i)+m|0}g[0]+=n;g[1]+=m;g[2]+=p;g[3]+=q}return CorectBits([g[0],g[1],g[2],g[3]])}function dell_get_serial_line(a){return"object"==typeof a?ArrayToString(a.slice(a.length-4,a.length)).toUpperCase():a.substr(a.length-4,a.length).toUpperCase()}function dell_get_serial_main(a){return a.substr(0,a.length-4)}
function choseEncode(a,b){function c(a,c,b){return(b^c)&a^b}function d(a,c,b){return(a^c)&b^c}function e(a,c,b){return c^a^b}function f(a,c,b){return(a|~b)^c}function h(a,c,b,d,e){return a(c,b,d)+e|0}function k(a,c,b,d,e){return a(c,b,d)+-e|0}function l(a,c,b){return(~b^c)&a^~b}function g(a,c,b){return~c^a^b}function n(a,c,b){return(~a|~b)^c}var m=dell_get_serial_line(b);return"D35B"==m?blockEncode(a,h,c,d,e,f,0):"1D3B"==m?blockEncode(a,k,l,d,g,n,1):blockEncode(a,k,l,d,g,n,0)}
...
function getBiosPwdForFSIhex(a){function b(a){var b=ord("0");return chr(b+(a>>12)%16%10)+chr(b+(a>>8)%16%10)+chr(b+(a>>4)%16%10)+chr(b+(a>>0)%16%10)}function c(a,b){for(var c=0,h=0,k=0;k<a.length;k++)h=b[(ord(a.charAt(k))^c>>8)%256],c=(c<<8^h)&65535;return c}20==a.length&&(a=a.slice(12,20));return function(a){for(var e=[],f=0,h=0;256>h;h++){for(var f=h<<8,k=0;8>k;k++)f<<=1,f&65536&&(f^=4129);e.push(f&65535)}return b(c(a.slice(0,4),e))+b(c(a.slice(4,8),e))}(a)}
