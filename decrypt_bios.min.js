...
function bruteForce(a,b,c,d,e,f){b="undefined"==typeof b?0:b;e="undefined"==typeof e?3:e;f="undefined"==typeof f?7:f;var g=[0,0,0,0,0,0,0];if(16383<a)return"Bad hash";var h=0;c=keys(!0==("undefined"==typeof d?!0:d)?keyboardDictChars:!0==("undefined"==typeof c?!1:c)?keyboardDictDigits:keyboardDict);for(d=c.length;;){for(var l=Math.random()*d,k=0;7>k;k++)g[k]=c[Math.floor(l%d)],l*=7;h++;if(5E4<h)return"No";for(k=e;k<=f;k++)if(badCRC16(g.slice(0,k),b)==a)return g=g.slice(0,k),keyboardEncToAscii(g)}}
...
function blockEncode(a,b,c,d,e,f){function g(a,c,b){c=c[b>>4][i&3];return SignedToUnsigned(a)/Math.pow(2,32-c)|SignedToUnsigned(a)<<c|0}function h(c,d,e){return l+b(c,k,m,p,MD5magic[e]+a[d])|0}var l=encData[0]|0,k=encData[1]|0,m=encData[2]|0,p=encData[3]|0,q=[[7,12,17,22],[5,9,14,20],[4,11,16,23],[6,10,15,21]],n;for(i=0;64>i;i++){switch(i>>4){case 0:n=h(c,i&15,i);break;case 1:n=h(d,5*i+1&15,i);break;case 2:n=h(e,3*i+5&15,i);break;case 3:n=h(f,7*i&15,i)}l=p;p=m;m=k;k=g(n,q,i)+k|0}return CorectBits([l+
encData[0],k+encData[1],m+encData[2],p+encData[3]])}function dell_get_serial_line(a){return"object"==typeof a?ArrayToString(a.slice(a.length-4,a.length)).toUpperCase():a.substr(a.length-4,a.length).toUpperCase()}function dell_get_serial_main(a){return a.substr(0,a.length-4)}
function choseEncode(a,b){function c(a,c,b){return(b^c)&a^b}function d(a,c,b){return(a^c)&b^c}function e(a,c,b){return c^a^b}function f(a,c,b){return(a|~b)^c}function g(a,c,b,d,e){return a(c,b,d)+e|0}function h(a,c,b,d,e){return a(c,b,d)+-e|0}function l(a,c,b){return(~b^c)&a^~b}function k(a,c,b){return~c^a^b}function m(a,c,b){return(~a|~b)^c}return"D35B"==dell_get_serial_line(b)?blockEncode(a,g,c,d,e,f):blockEncode(a,h,l,d,k,m)}
